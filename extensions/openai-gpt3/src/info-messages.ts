...
The token count of your prompt plus this parameter cannot exceed the model's context length. "text-davinci-002", "text-davinci-003" and "gpt-3.5-turbo*" models have a context length of 4000 tokens, while the others have 2048.
